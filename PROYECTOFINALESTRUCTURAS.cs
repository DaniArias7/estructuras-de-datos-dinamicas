...
class Program
{
    static void Main()
    {
        ...
        } while (PreguntarSiOtroArbol("¿Quieres crear otro árbol?"));
    ...
    static bool PreguntarSiOtroArbol(string mensaje)
    {
        Console.WriteLine($"{mensaje} (responde 's' para sí o 'n' para no):");
